...
| `PGBOUNCER_MAX_DB_CONNECTIONS`        | PgBouncer maximum number of connections allowed per database (default: 0).                                                                                                                     | `nil`                   |
| `PGBOUNCER_MAX_USER_CONNECTIONS`        | PgBouncer maximum number of connections allowed per user (default: 0).                                                                                                                     | `nil`                   |
